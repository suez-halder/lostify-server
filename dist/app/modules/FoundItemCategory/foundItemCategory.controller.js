...
const createFoundItemCategoryIntoDB = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield foundItemCategory_service_1.FoundItemCategoryService.createFoundItemCategoryIntoDB(req.body);
